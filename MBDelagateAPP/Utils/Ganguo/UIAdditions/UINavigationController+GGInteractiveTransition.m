                                                  ...
                                                  toViewController:(UIViewController *)toVC
{
    ...
    if (self.opperation == UINavigationControllerOperationPush || (self.opperation == UINavigationControllerOperationPop && !self.isInteractive)) {
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    CGRect finalFromViewControllerFrame = CGRectMake(fromViewEndX, 64,
                                                     finalToViewControllerFrame.size.width,
                                                     finalToViewControllerFrame.size.height);
    
    CGRect initalToViewControllerFrame = CGRectMake(toViewStartX, 64,
                                                    finalToViewControllerFrame.size.width,
                                                    finalToViewControllerFrame.size.height);
